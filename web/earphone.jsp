                    ...
                    <div class="col-12">
                        ...
                        <div class="woocommerce columns-4 ">
                            <div class="row row-items columns-4">
                                ...
                                <c:forEach var="x" items="${p.productsType}">
                                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                                        <div class="item item-product product type-product post-175 status-publish first instock product_cat-mobiles-tablets product_tag-apple product_tag-mobile has-post-thumbnail sale shipping-taxable purchasable product-type-simple">
                                            ...
                                            <div class="item-content">
                                                ...
                                                <p class="item-title"><a href="infoProduct?id=${x.id}"> ${x.name} </a></p><span class="price"><del><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&#36;</span>${Math.ceil(x.price * 1.3 * 100.0) / 100.0}</span>
        ...
        <div class="container">
            <ul class="pagination">
                <li><a href="?page=${param.page>1?param.page-1:1}">«</a></li>
                    <c:forEach var="i" begin="1" end="${p.pagesType}" step="1">
                    <li class="${i==param.page?"active":""}"><a href="?page=${i}&type=${param.type}">${i}</a></li>
                    </c:forEach>
                <li><a href="?page=${param.page<p.pagesType?param.page+1:p.pagesType}&type=${param.type}">»</a></li>
            </ul>
        </div>
